...
public:
	...
	cMesh(std::vector<sVertex> theVertices, std::vector<unsigned int> theIndices, std::vector<sTexture> theTextures, std::vector<glm::mat4> modelMatrices, GLuint texID);
...
private:
	...
	std::vector<glm::mat4> vecMatrices;
	GLuint texID;
	bool isInstanced;
};
